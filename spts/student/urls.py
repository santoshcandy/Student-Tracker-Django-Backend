...
from .views import StudentDashBoardView,StudentLoginView,StudentProfileInfoView,StudentListView,SubjectListView,SubjectRegister
urlpatterns=[
    ...
    path('subject/register/', SubjectRegister.as_view()),
]
